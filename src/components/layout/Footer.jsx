                        ...
                        <div className="flex gap-4 mt-4">
                            {socialLinks.map((social, index) => (
                                <motion.a
                                    ...
                                    className="w-12 h-12 rounded-full bg-neutral-dark border border-neutral-dark flex items-center justify-center text-neutral-medium hover:text-white hover:border-white/50 hover:bg-neutral-dark transition-all group"
                            ...
                            {navLinks.map((link, index) => (
                                <li key={index}>
                                    <a href={link.href} className="text-neutral-400 hover:text-white flex items-center gap-2 group transition-colors w-fit">
                                        <span className="w-1.5 h-1.5 rounded-full bg-neutral-medium group-hover:bg-white transition-colors" />
